...
DIST="$ROOT/dist"
mkdir -p "$DIST"
cp app/build/outputs/apk/release/app-release.apk "$DIST/LVDC-Terminal.apk"
cp app/build/outputs/apk/release/app-release.apk "$ROOT/web/public/LVDC-Terminal.apk"
echo "✅ APK : $DIST/LVDC-Terminal.apk"
